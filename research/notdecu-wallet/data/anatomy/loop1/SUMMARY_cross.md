...
- slingoor/ETH: market accounts extended to 2 (LaunchLab vault authority added); Phase B's dev_first_buy_sol/sol_in_* for this launch are rent only and were not used
- slingoor/ETH: no create transaction found in the window
...
- slingoor/GRND: market accounts extended to 2 (LaunchLab vault authority added); Phase B's dev_first_buy_sol/sol_in_* for this launch are rent only and were not used
- slingoor/GRND: no create transaction found in the window
- slingoor/MPN: no trades in the window (sig_source=mint, 1 tx); excluded from every denominator
...
- slingoor/LMAO!: market accounts extended to 2 (LaunchLab vault authority added); Phase B's dev_first_buy_sol/sol_in_* for this launch are rent only and were not used
...
- slingoor/USDC: market accounts extended to 2 (LaunchLab vault authority added); Phase B's dev_first_buy_sol/sol_in_* for this launch are rent only and were not used
...
- slingoor/GREEN: market accounts extended to 2 (LaunchLab vault authority added); Phase B's dev_first_buy_sol/sol_in_* for this launch are rent only and were not used
...
- slingoor/DAMN: market accounts extended to 1 (LaunchLab vault authority added); Phase B's dev_first_buy_sol/sol_in_* for this launch are rent only and were not used
