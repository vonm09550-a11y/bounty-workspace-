...
| 2.4 ✅ | Token universe | Done — see `05-selection-profile.md`: 27,902 tokens, 100% coverage, 0 errors; 90% Pump.fun; median age at entry 9 s (77% ≤30 s); 19% of picks migrated and produced 56% of P&L at 75% win; half of volume from 292 factory creators; devs with 2–20 prior launches won 69% vs 63% for factories. **Last decu run** | 26,655 calls (w1), 187 min at 0.42 s/token | done | `tokens` table, `data/tokens.parquet`, `05-selection-profile.md` | passed |
...
| Item | State | Output |
|---|---|---|
| 2.4 (last decu run) | ✅ done 20:20 UTC | `05-selection-profile.md` |
